...
#
# Subcommands:
#   up       Bring the stack up. Builds artefacts, generates override,
#            starts every service per the chosen profile.
...
YML
  ...
  echo "Seed demo data: ./dev-compose.sh seed"
}
...
Subcommands:
  up      Build artefacts + start the stack.
