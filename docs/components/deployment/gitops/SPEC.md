...
- **Image signing.** GHCR images are not yet signed (cosign). The deploy admits any tag the poller resolves. Adding `cosign verify` to the poller and to the cluster admission policy is a follow-up.
